...
void gmx::Integrator::do_md()
{
    ...
    double x1;// Shivani
    double x2;// Shivani
//    for (int n_loop = 0; n_loop < 10000000; n_loop++)
//    {
//    printf("%f\n",gauss_dist(x1,x2));
//    }   //n_loop
    /*---------------     Edited by Shivani   --------------------*/
...
/*   ------------------------------------- Edited by Shivani   ---------------------------------*/
     ...
     real friction = 10.0, k_bol = 8.314e-3;
...
// thermostat half-step
        running_v_lambda=c1*running_v_lambda+c2*gauss_dist(x1,x2);
// thermostat half-step
        running_v_lambda=c1*running_v_lambda+c2*gauss_dist(x1,x2);
...
//            printf("%f\t%f\t%f\n", state->lambda[0], running_v_lambda, temp_lambda);
/*-----------------------------                   Edited by Shivani    ----------------------------------------*/
        wallcycle_stop(wcycle, ewcUPDATE);
